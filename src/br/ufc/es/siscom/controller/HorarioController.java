...
public class HorarioController {
	...
	public String deletarHorario(){
		...
		if(horariosConfirmados==null||horariosConfirmados.isEmpty()){
			...
			FacesMessage msg = new FacesMessage(FacesMessage.SEVERITY_FATAL, "Nãoo é possivel deletar Horario pois ele possui alunos confirmados", "Monitor possui horarios");
