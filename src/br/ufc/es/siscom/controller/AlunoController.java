...
public class AlunoController {
  ...
  public String salvar() {
    List<Disciplina> disciplinasAluno = DisciplinaDAO
        .retornarListaDeDisciplinaPorListaDeNomes(nomeDisciplinasSelecionadas);
  ...
  public void setNomeDisciplinasSelecionadas(ArrayList<String> nomeDisciplinasSelecionadas) {
